...
namespace SWP391_BE.Controllers
{
    ...
    public class DashboardController : ControllerBase
    {
        ...
        // API: Th?ng k� s? ki?n y t? theo th?i gian
        ...
        public async Task<IActionResult> GetMedicalEventsTimeline([FromQuery] string eventType = null, [FromQuery] string period = "30days")
        {
            try
            {
                ...
                if (eventType != null && !new[] { "tai n?n", "d?ch b?nh", "s?t", "kh�c" }.Contains(eventType.ToLower()))
                {
                    return BadRequest(new { message = "Invalid eventType. Must be tai n?n, d?ch b?nh, s?t, or kh�c." });
                }
        ...
        // API: T? l? ti�m ch?ng theo chi?n d?ch v� l?p
        ...
        // API: Hi?u qu? chi?n d?ch ti�m ch?ng
        ...
        // API: Thống kê hoạt động của y tá
        ...
        // API: So s�nh ch? s? gi?a hai kho?ng th?i gian
