...
{
    /// <inheritdoc />
    public partial class DeployServer : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeftEye = table.Column<double>(type: "float", nullable: true),
                    RightEye = table.Column<double>(type: "float", nullable: true),
                    HealthCheckDescription = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "HealthConsultationBooking",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthConsultationBooking", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK_HealthConsultationBooking_Account_NurseId",
                        column: x => x.NurseId,
                        principalTable: "Account",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HealthConsultationBooking_Account_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Account",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HealthConsultationBooking_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeftEye = table.Column<double>(type: "float", nullable: false),
                    RightEye = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthConsultationBooking_NurseId",
                table: "HealthConsultationBooking",
                column: "NurseId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthConsultationBooking_ParentId",
                table: "HealthConsultationBooking",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_HealthConsultationBooking_StudentId",
                table: "HealthConsultationBooking",
                column: "StudentId");
