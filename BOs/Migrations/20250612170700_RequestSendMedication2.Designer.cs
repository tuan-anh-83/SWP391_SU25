...
namespace BOs.Migrations
{
    ...
    [Migration("20250612170700_RequestSendMedication2")]
    partial class RequestSendMedication2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicationParentMedicationRequest", b =>
                {
                    b.Property<int>("MedicationsMedicationId")
                        .HasColumnType("int");

                    b.Property<int>("ParentMedicationRequestRequestId")
                        .HasColumnType("int");

                    b.HasKey("MedicationsMedicationId", "ParentMedicationRequestRequestId");

                    b.HasIndex("ParentMedicationRequestRequestId");

                    b.ToTable("ParentMedicationRequestMedication", (string)null);
                });
            ...
            modelBuilder.Entity("MedicationParentMedicationRequest", b =>
                {
                    ...
                    b.HasOne("BOs.Models.ParentMedicationRequest", null)
                        .WithMany()
                        .HasForeignKey("ParentMedicationRequestRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
